...
for epoch in range(opt.n_epochs):
    ...
    if epoch % 10 == 0:
        generator.save("generator_last_1.pkl")
        discriminator.save("discriminator_last_1.pkl")

generator.eval()
discriminator.eval()
generator.load('generator_last_1.pkl')
discriminator.load('discriminator_last_1.pkl')

number = '14044011403196'
n_row = len(number)
